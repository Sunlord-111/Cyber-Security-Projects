...
## What It Does
Scans a target IP or hostname for open TCP ports and identifies 
running services. Built as a foundational network reconnaissance 
tool — the same core concept behind Nmap.
...
explicit written permission to scan. Unauthorized port scanning 
